    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="15" :sm="18" :md="20" :lg="20" :xl="20">
        ...
        <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
          ...
          <el-table-column prop="employee.employeeCode" label="工号"/>
          <el-table-column prop="employee.employeeName" label="真名"/>
          <el-table-column :show-overflow-tooltip="true" prop="employee.dingId" label="钉钉ID"/>
          <el-table-column :show-overflow-tooltip="true" prop="employee.pageBelongDepts" label="部门"/>
          <el-table-column label="角色">
            <template slot-scope="scope">
              <div>{{ scope.row.roles | filterRoles }} </div>
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    edit(data) {
      ...
      _this.employeeCodeChange(data.employee.employeeCode)
